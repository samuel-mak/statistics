...
- **The Linear Model for 2-group ANOVA**
  - **Mathematics**
    - $y_{ik} = \beta_{0} + \beta_{k}x_k + \epsilon_{ik}$
        - ***Where***
          ...
          - $\beta_{1}x_1$
            - The effect of level $k$ of the categorical predictor variable relative to the overall/grand mean
              This is equivalent to $\tau_k$
          - $x_k$ 
          ...
          - $\beta_{0} + \beta_{k}x_k$ 
            - The predicted/expected mean of group $k$
            - This is equivalent to $\mu_k$
          - $\epsilon_{ik}$ 
            - The random error of observation $i$ in group $k$
            - Error is a random independent normal variable with $E(\epsilon_{ik}) = 0$ and $Var(\epsilon_{ik}) = \sigma^2$
