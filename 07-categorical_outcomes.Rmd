...
- **Information**
  - **Concept**
    - A quantity that quantifies the amount of information that an observable random variable/sample data carries about an unknown parameter of a statistical model of that random variable 
  ...
  - **Information defined as the variance of the score (a random variable)**
    - **Concept**
      - Information can be defined as the variance of the score ($\frac{\partial \mathcal{l}(\theta; \text{x})}{\partial \theta}$)
    - **Mathematics** 
