...
ggplot2::ggplot() + 
  ...
  scale_y_continuous(limits = c(0, 21), breaks = seq(0, 22, 1)) +
  annotate(geom = "segment", x = 2, y = 4, xend = 6, yend = 20) +
  annotate(geom = "segment", x = 2, y = 4, xend = 11, yend = 7) +
  annotate(geom = "segment", x = 11, y = 7, xend = 55/17, yend = 152/17) +coord_fixed()
```
